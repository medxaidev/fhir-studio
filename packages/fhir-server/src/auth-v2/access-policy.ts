 ...
 * - **Layer 2: canPerformInteraction()** — Instance-level check
 * - **Layer 3: getSearchCriteria()** — Search criteria injection
 *
 * Adapted from medxai/fhir-server auth/access-policy.ts — uses local types,
